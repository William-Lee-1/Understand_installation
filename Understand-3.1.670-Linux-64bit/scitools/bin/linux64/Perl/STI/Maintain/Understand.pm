#
#          Copyright (c) 2000-2011, Scientific Toolworks, Inc.
#
...
# Understand::Visio
#
package Understand::Visio;
use strict;

sub draw {
  my $ent = shift;
  Understand::Api::visio_draw($$ent,@_);
}
sub quit {Understand::Api::visio_quit();}
...
using the command C<$ent-E<gt>draw()>. On Windows with Visio installed, vsd files
may also be created.
...
=head4 C<$ent-E<gt>draw( $kind, $filename [,$options] )>
  ...
  either the extension .jpg, .png, .dot, .vdx or .svg.  This command is not
  ...
  One of the following status strings will be returned on error:
    ...
    "UnsupportedFile"  - only .jpg, .png, .vdx, .dot or .svg files are supported.
...
=head2 Understand::Visio class

=head4 C<Understand::Visio::draw( $ent,$kind,$filename [,$options] )>
  ...
  to a .vsd file ($filename). Visio will continue running after this
  call (for efficiency reasons), but may be forced to quit using
...
have been listed beneath them.
 ...
 Method
    ...
    Basic Friend Member Method
    Basic Unresolved Friend Member Extern Method
    Basic Friend Member Method MustOverride
    Basic Friend Member Method NotInheritable
    Basic Friend Member Method Overridable
    Basic Friend Member Method Shared
    Basic Protected Constructor Member Method
    Basic Protected Member Method
    Basic Unresolved Protected Member Extern Method
    Basic Protected Member Method MustOverride
    Basic Protected Member Method NotInheritable
    Basic Protected Member Method Overridable
    Basic Protected Member Method Shared
    Basic Protected Friend Constructor Member Method
    Basic Protected Friend Member Method
    Basic Unresolved Protected Friend Member Extern Method
    Basic Protected Friend Member Method MustOverride
    Basic Protected Friend Member Method NotInheritable
    Basic Protected Friend Member Method Overridable
    Basic Protected Friend Member Method Shared
    Basic Private Constructor Member Method
    Basic Private Member Method
    Basic Unresolved Private Member Extern Method
    Basic Private Member Method Shared
    Basic Public Constructor Member Method
    Basic Public Member Method
    Basic Unresolved Public Member Extern Method
    Basic Public Member Method MustOverride
    Basic Public Member Method NotInheritable
    Basic Public Member Method Overridable
    Basic Public Member Method Shared
